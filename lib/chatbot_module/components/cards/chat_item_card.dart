...
import 'package:penniverse/chatbot_module/models/chat_model.dart';
import 'package:penniverse/chatbot_module/utils/constants.dart';
import 'package:penniverse/chatbot_module/utils/helper_widgets.dart';
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: widget.chatItem.chatType == ChatType.error
                    ...
                    ? widget.botChatBubbleColor.withOpacity(0.8)
                    : widget.userChatBubbleColor.withOpacity(0.8),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.chatItem.chatType != ChatType.loading)
                    RichText(
                      text: formatText(widget.chatItem.message),
                    ),
                ],
              ),
            ),
