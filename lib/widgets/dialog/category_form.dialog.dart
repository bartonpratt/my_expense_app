          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  ...
                  decoration: InputDecoration(
                      ...
                      filled: true,
                      fillColor: _category.color.withOpacity(0.2),
              ...
              children: [
                ...
                CoolDropdown<String>(
                  dropdownList: [
                    ...
                    CoolDropdownItem<String>(
                        value: "Income",
                        label: 'Income (Default)'), // Default option
                  ],
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ColorPickerHelper.pickColor(context, _category.color,
                        (Color color) {
                      setState(() {
                  ...
                  child: Container(
                    padding: const EdgeInsets.all(
                        4.0), // Add space between the outline and the container
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(
                          44), // Increase the border radius slightly for the outer container
                      border: Border.all(
